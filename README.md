...
| proj+reduce (fwd) | 81          | 61                            | 96                     |                                                           |
| proj+reduce (bwd) | 170         | 169                           | 425                    | Try to enable auto-tune for tilelang kernels, but failed. |
...
Sinkhorn is omitted because it is the same as the `h=7168` case.


| Kernel                 | TE (Triton) | Megatron-LM (cuTile + Triton) | TileKernels (TileLang) |
| ---------------------- | ----------- | ----------------------------- | ---------------------- |
